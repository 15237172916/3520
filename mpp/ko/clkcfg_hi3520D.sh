...
#AIOx(x=0~1)
#himm 0x20030080 0X0025485f   #Mclk  crg32  输入
#himm 0x20030084 0x0125485f   #AOP0  MUX/MCLK  crg33  输入、输出
#himm 0x20030088 0x0025485f   #AOP1  MCLK  crg34  输入
#himm 0x2003008C 0x2          #AIO   CLK/RESET  crg35  输入、输出
#himm 0x20030090 0x000015c2   #AIP0  时钟复位分频crg36 输入
#himm 0x20030094 0x000015d2   #AOP0  时钟复位分频crg37 输入、输出
#himm 0x20030098 0x000015d2   #AOP0  时钟复位分频crg38 输出